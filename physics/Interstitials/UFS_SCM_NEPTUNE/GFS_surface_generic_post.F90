...
!!
      subroutine GFS_surface_generic_post_run (im, cplflx, cplaqm, cplchm, cplwav, cpllnd, cpllm4, cpl_fire, lssav, dry, icy, wet,  &
        ...
        logical,                                intent(in) :: cplflx, cplaqm, cplchm, cplwav, cpllnd, cpllm4, cpl_fire, lssav
