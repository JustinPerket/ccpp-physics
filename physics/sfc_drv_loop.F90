...
!  ---  inputs:
      real(kind=kind_phys),  dimension(im), intent(in) :: z1,prsik1, &
           z0pert,ztpert,tskin_lnd,tsurf_lnd,z0rl_lnd,ustar_lnd
!  ---  outputs:
...
!!!     for stability      ----------------------------------------------
      real(kind=kind_phys), dimension(im), intent(inout) :: rb_lnd, fm_lnd,    &
           fh_lnd, fm10_lnd, fh2_lnd,stress_lnd, ustar_lnd
